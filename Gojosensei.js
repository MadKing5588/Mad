...
await GojoMdNx.send5ButImg(from, `` + '' + ' ', `(مَا يَلْفِظُ مِنْ قَوْلٍ إِلَّا لَدَيْهِ رَقِيبٌ عَتِيدٌ) [ق:18]

(الـدال عـلـى الـخـيـر كـفـآعـلـه) 

رواه الترمذي في سُننه عن أنس بن مالك

شـآركـنـا الأجر ♥.

https://chat.whatsapp.com/IEZhOevPUYrBHpcsdwr8Pw  .`,unicorn, [{"urlButton": {"displayText": "「 قناتي 」「📍」◣","url": `${myweb}`}},{"urlButton": {"displayText": "「 رابط الاستقبال 」「📌」◣","url": `${sc}`}},{"quickReplyButton": {"displayText": "「 الاستلام 」「🍜」◣","id": 'donate'}},{"quickReplyButton": {"displayText": "「 المالك 」「👤」◣","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
